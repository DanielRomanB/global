                            ...
                            <div class="carousel-item align-content-center active">
                                <div class="row">
                                    <div class="col-sm-6  d-flex align-items-center">
                                        <img src="{{asset('img/login/logoazul.png')}}" class="rounded d-block w-100  imagenes " alt="...">
                                    </div>
                ...
                <div class="p-3 div-small">
                    ...
                    <form action="" class="login-form">
                        ...
                        <div class="input-box password-container">
                            ...
                            <input type="password" id="password-input" autocomplete="off" required placeholder="Ingresa tu contraseña">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <a href="..." data-bs-toggle="modal" data-bs-target="#exampleModal" class="link-offset-2 link-underline link-underline-opacity-0 float-end">Recuperar contraseña</a>
                        </div>
                        <div class="d-grid gap-2 pb-2">
                            <button class="btn btn-primary" type="button" id="loginButton">Iniciar sesión</button> 
                        </div>
                        <p class="text-center pt-2">¿Quieres consultar un comprobante? <b><a href="#" class="link-offset-2 link-underline link-underline-opacity-0" data-bs-toggle="modal" data-bs-target="#exampleModalComprobante"> Consultar </a></b></p>
                    </form>
                </div>
